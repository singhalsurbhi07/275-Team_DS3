...
#JAVA_OPTS='-Xdebug -Xrunjdwp:transport=dt_socket,address=4050,server=y,suspend=n'
JAVA_OPTS=''

java ${JAVA_TUNE} ${JAVA_OPTS} -cp .:${POKE_HOME}/lib/'*':${POKE_HOME}/classes ${JAVA_MAIN} ${JAVA_ARGS} 
