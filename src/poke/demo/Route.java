...
public class Route {
  ...
  public void run(int choice) throws IOException {
    ...
    switch (choice) {
      case 1 :
        System.out
            .println("Enter the complete path of the file you need to upload \n");
        filePath = bufferRead.readLine();
        System.out.println("Enter to which node you want to upload the file");
        String dest = bufferRead.readLine();
        System.out.println("dest " + dest);
        System.out.println("Flepath-->>" + filePath);
