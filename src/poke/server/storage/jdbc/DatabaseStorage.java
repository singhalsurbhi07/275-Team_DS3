...
import poke.resources.RetrieveResource;
...
public class DatabaseStorage implements Storage {
    ...
    public RetrieveResource retrieveResource;
    ...
    @Override
    public boolean addDocument(Request request, String filePath,
	    String serverPort) {
	System.out
	...
	try {
	    ...
	    if (findrs.next()) {
		fileInfo = new FileInfo();
		fileInfo.setFilePath(findrs.getString("file_path"));
		fileInfo.setServerPort(findrs.getString("server_port"));
		fileInfo.setServerIp(findrs.getString("server_ip"));
		fileInfo.setFileName(findrs.getString("file_name"));
	    }
    ...
    @Override
    public boolean removeDocument(String fileName, long docID) {
	// TODO Auto-generated method stub
	return false;
    }
}
